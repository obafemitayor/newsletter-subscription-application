...
const validateRequiredField = (field: string, value: string, localise: Function) => {
    if(!value.trim()) {
        return {
            isValid: false,
...
const validateCategories = (categoryGuids: string[], localise: Function): Validation =>  {
...
const validateEmail = (email: string, localise: Function): Validation => {
...
export const validateField = (field: string, value: string | string[], localise: Function): Validation => {
